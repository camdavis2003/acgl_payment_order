/* Generated from app.js by generate-page-bundles.js: budget-dashboard. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:budget-dashboard-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:budget-dashboard-remove-ledger-income-wise-pages] removed in page-specific build.

  // [bundle-strip:budget-dashboard-remove-editor] removed in page-specific build.
function initBudgetDashboard() {
  ...
  // [bundle-strip:budget-dashboard-remove-archive-and-backup] removed in page-specific build.

  // [bundle-strip:budget-dashboard-remove-backups] removed in page-specific build.
// ---- Event wiring (only when the elements exist on the page) ----
  ...
  // [bundle-strip:budget-dashboard-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:budget-dashboard-remove-itemize] removed in page-specific build.
