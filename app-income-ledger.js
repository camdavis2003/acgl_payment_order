/* Generated from app.js by generate-page-bundles.js: income-ledger. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:income-ledger-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:income-ledger-remove-money-transfers] removed in page-specific build.
function loadIncome(year) {
  ...
  // [bundle-strip:income-ledger-remove-wise-pages] removed in page-specific build.
function initBudgetEditor() {
  ...
  // [bundle-strip:income-ledger-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:income-ledger-remove-itemize] removed in page-specific build.
