/* Generated from app.js by generate-page-bundles.js: money-transfers. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:money-transfers-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:money-transfers-remove-builder-page] removed in page-specific build.

  // [bundle-strip:money-transfers-remove-income-and-banking-pages] removed in page-specific build.

  // [bundle-strip:money-transfers-remove-backups] removed in page-specific build.
// ---- Event wiring (only when the elements exist on the page) ----
  ...
  // [bundle-strip:money-transfers-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:money-transfers-remove-itemize] removed in page-specific build.
