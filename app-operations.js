/* Generated from app.js by generate-page-bundles.js: operations. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:operations-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:operations-remove-money-transfers] removed in page-specific build.
function loadIncome(year) {
  ...
  // [bundle-strip:operations-remove-budget-editor] removed in page-specific build.
function initArchivePage() {
  ...
  // [bundle-strip:operations-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:operations-remove-itemize] removed in page-specific build.
