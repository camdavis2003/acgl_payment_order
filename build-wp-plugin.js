...
function patchAssetUrlsInHtml(html, version) {
  ...
  const assets = ['styles.css', 'hoverPopup.css', 'hoverPopup.js', 'user-roles.js', 'datastore.js', 'app.js', 'app-request.js', 'app-workflows.js', 'app-settings.js', 'app-shell.js', 'iban.js', 'bic.js', 'table-enhancements.js', 'pdf-lib.min.js'];
  let out = String(html || '');
