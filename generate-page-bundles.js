...
const OUT_MONEY_TRANSFER_LIST = path.join(ROOT, 'app-money-transfer-list.js');
const OUT_MONEY_TRANSFER_BUILDER = path.join(ROOT, 'app-money-transfer-builder.js');
...
function main() {
  ...
  writeBundle(OUT_MONEY_TRANSFER_LIST, moneyTransfers);
  writeBundle(OUT_MONEY_TRANSFER_BUILDER, moneyTransfer);
