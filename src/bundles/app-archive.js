/* Generated from app.js by generate-page-bundles.js: archive. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:archive-remove-orders-and-reconciliation] removed in page-specific build.

  // [bundle-strip:archive-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:archive-remove-ledger-income-wise-pages] removed in page-specific build.

  // [bundle-strip:archive-remove-budget-editor] removed in page-specific build.
function initArchivePage() {
  ...
  // [bundle-strip:archive-remove-backups] removed in page-specific build.
// ---- Event wiring (only when the elements exist on the page) ----
  ...
  // [bundle-strip:archive-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:archive-remove-itemize] removed in page-specific build.
