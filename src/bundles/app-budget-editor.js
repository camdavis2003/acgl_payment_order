/* Generated from app.js by generate-page-bundles.js: budget-editor. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:budget-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:budget-remove-ledger-income-wise-pages] removed in page-specific build.
function initBudgetEditor() {
  ...
  // [bundle-strip:budget-remove-dashboard] removed in page-specific build.

  // [bundle-strip:budget-remove-archive-and-backup] removed in page-specific build.

  // [bundle-strip:budget-remove-backups] removed in page-specific build.
// ---- Event wiring (only when the elements exist on the page) ----
  ...
  // [bundle-strip:budget-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:budget-remove-itemize] removed in page-specific build.
