/* Generated from app.js by generate-page-bundles.js: gs-ledger. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:gs-ledger-remove-reconciliation-page] removed in page-specific build.

  // [bundle-strip:gs-ledger-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:gs-ledger-remove-money-transfers] removed in page-specific build.
function loadIncome(year) {
  ...
  // [bundle-strip:gs-ledger-remove-income-page] removed in page-specific build.

  // [bundle-strip:gs-ledger-remove-wise-pages] removed in page-specific build.
function initBudgetEditor() {
  ...
  // [bundle-strip:gs-ledger-remove-backups] removed in page-specific build.
// ---- Event wiring (only when the elements exist on the page) ----
  ...
  // [bundle-strip:gs-ledger-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:gs-ledger-remove-itemize] removed in page-specific build.
