/* Generated from app.js by generate-page-bundles.js: money-transfer. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:money-transfer-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:money-transfer-remove-list-page] removed in page-specific build.
// ---- Money Transfer builder page ----
  ...
  // [bundle-strip:money-transfer-remove-income-and-banking-pages] removed in page-specific build.

  // [bundle-strip:money-transfer-remove-backups] removed in page-specific build.
// ---- Event wiring (only when the elements exist on the page) ----
  ...
  // [bundle-strip:money-transfer-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:money-transfer-remove-itemize] removed in page-specific build.
