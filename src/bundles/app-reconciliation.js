/* Generated from app.js by generate-page-bundles.js: reconciliation. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:reconciliation-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:reconciliation-remove-ledger-income-wise-pages] removed in page-specific build.

  // [bundle-strip:reconciliation-remove-budget-editor] removed in page-specific build.

  // [bundle-strip:reconciliation-remove-archive-page] removed in page-specific build.

  // [bundle-strip:reconciliation-remove-backups] removed in page-specific build.
// ---- Event wiring (only when the elements exist on the page) ----
  ...
  // [bundle-strip:reconciliation-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:reconciliation-remove-itemize] removed in page-specific build.
