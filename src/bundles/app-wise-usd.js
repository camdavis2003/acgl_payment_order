/* Generated from app.js by generate-page-bundles.js: wise-usd. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:wise-usd-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:wise-usd-remove-ledger-page] removed in page-specific build.

  // [bundle-strip:wise-usd-remove-income-page] removed in page-specific build.

  // [bundle-strip:wise-usd-remove-wise-eur-page] removed in page-specific build.
...
function initWiseUsdListPage() {
  ...
  // [bundle-strip:wise-usd-remove-budget-editor] removed in page-specific build.
function initArchivePage() {
  ...
  // [bundle-strip:wise-usd-remove-backups] removed in page-specific build.
// ---- Event wiring (only when the elements exist on the page) ----
  ...
  // [bundle-strip:wise-usd-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:wise-usd-remove-itemize] removed in page-specific build.
