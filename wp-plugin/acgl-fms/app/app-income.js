/* Generated from app.js by generate-page-bundles.js: income. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:income-remove-reconciliation-page] removed in page-specific build.

  // [bundle-strip:income-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
...
function initIncomeListPage() {
  ...
  // [bundle-strip:income-remove-wise-pages] removed in page-specific build.
function initBudgetEditor() {
  ...
  // [bundle-strip:income-remove-backups] removed in page-specific build.
// ---- Event wiring (only when the elements exist on the page) ----
  ...
  // [bundle-strip:income-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:income-remove-itemize] removed in page-specific build.
