/* Generated from app.js by generate-page-bundles.js: wise-eur. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:wise-eur-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:wise-eur-remove-ledger-page] removed in page-specific build.

  // [bundle-strip:wise-eur-remove-income-page] removed in page-specific build.
function initWiseEurListPage() {
  ...
  // [bundle-strip:wise-eur-remove-wise-usd-page] removed in page-specific build.

  // [bundle-strip:wise-eur-remove-budget-editor] removed in page-specific build.
function initArchivePage() {
  ...
  // [bundle-strip:wise-eur-remove-backups] removed in page-specific build.
// ---- Event wiring (only when the elements exist on the page) ----
  ...
  // [bundle-strip:wise-eur-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:wise-eur-remove-itemize] removed in page-specific build.
