/* Generated from app.js by generate-page-bundles.js: wise. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:wise-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:wise-remove-ledger-page] removed in page-specific build.

  // [bundle-strip:wise-remove-income-page] removed in page-specific build.
function initWiseEurListPage() {
  ...
  // [bundle-strip:wise-remove-budget-editor] removed in page-specific build.
function initArchivePage() {
  ...
  // [bundle-strip:wise-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:wise-remove-itemize] removed in page-specific build.
