/* Generated from app.js by generate-page-bundles.js: workflows. Do not edit manually. */
/*
...
(async () => {
  ...
  // [bundle-strip:workflows-remove-settings] removed in page-specific build.
// ---- Income (year-scoped) ----
  ...
  // [bundle-strip:workflows-remove-money-transfers] removed in page-specific build.
function loadIncome(year) {
  ...
  // [bundle-strip:workflows-remove-request-form] removed in page-specific build.
  ...
  // [bundle-strip:workflows-remove-itemize] removed in page-specific build.
